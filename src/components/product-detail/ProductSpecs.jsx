    ...
    <div>
      ...
      <div className="flex items-center sm:justify-start justify-between pt-2">
        <div className="flex sm:gap-3 gap-2 items-center">
          ...
          <span className="line-through text-sm sm:text-base text-black-400 font-thin">
        ...
        <div className="space-y-2 sm:pt-10 pt-8">
          ...
          <div className="flex gap-2">
            <input
              ...
              className="border-0 border-b-2 border-[#333333] bg-transparent font-normal text-sm placeholder:font-aspekta placeholder-shown:px-0 pt-0 md:placeholder-shown:text-[16px] w-full focus:outline-none focus:ring-0 focus:border-[#DD1E24]"
            />
